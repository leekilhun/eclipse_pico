...
C_SRCS += \
../src/lib/tinyusb/src/class/net/net_device.c 

OBJS += \
./src/lib/tinyusb/src/class/net/net_device.o 

C_DEPS += \
./src/lib/tinyusb/src/class/net/net_device.d 


# Each subdirectory must supply rules for building sources it contributes
src/lib/tinyusb/src/class/net/net_device.o: E:/eclipse-workspace/pico/raspberry_pico_fw/src/lib/tinyusb/src/class/net/net_device.c src/lib/tinyusb/src/class/net/subdir.mk
	@echo 'Building file: $<'
